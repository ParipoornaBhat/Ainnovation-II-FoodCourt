...
import { ArrowRight, Users, Shield, Utensils } from "lucide-react"
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 text-pretty max-w-2xl mx-auto">
              Streamline your team's food ordering experience with our modern platform. Manage events, teams, and orders
              all in one place.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardDescription>Organize teams, manage permissions, and track orders efficiently</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardDescription>Manage food items, quantities, and dietary restrictions with ease</CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <CardHeader className="text-center">
                ...
                <CardDescription>
                  Complete administrative control over events, orders, and system settings
                </CardDescription>
              </CardHeader>
            </Card>
          </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join teams already using FoodCourt for their corporate food ordering needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
