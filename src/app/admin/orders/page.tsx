...
export default function OrderManagement() {
  ...
  const orders = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Quinoa Bowl", quantity: 2, price: 13.25, previouslyOrdered: 1 },
      ],
      status: "delivered",
    ...
    },
    {
      ...
      items: [{ name: "Fish Tacos", quantity: 4, price: 16.75, previouslyOrdered: 0 }],
      status: "pending",
    ...
    },
    {
      ...
      items: [
        { name: "Beef Burger", quantity: 2, price: 18.99, previouslyOrdered: 0 },
        { name: "Caesar Salad", quantity: 2, price: 9.99, previouslyOrdered: 1 },
      ],
      status: "cancelled",
    ...
    },
    {
      ...
      items: [{ name: "Quinoa Bowl", quantity: 3, price: 13.25, previouslyOrdered: 2 }],
      status: "in-progress",
  ...
  const handlePaymentUpdate = async (orderId: number, newPaymentStatus: string) => {
    ...
    console.log(`Updated order ${orderId} payment status to ${newPaymentStatus}`)
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Track and manage all food orders</p>
          </div>
          <div className="flex items-center space-x-2">
            <Switch id="override-restrictions" />
            <Label htmlFor="override-restrictions" className="text-sm font-medium">
                  ...
                  <TableRow key={order.id} className="hover:bg-muted/50">
                              ...
                              <div key={index} className="flex justify-between items-center p-3 border rounded">
                                <div>
                                  ...
                                  <p className="text-sm text-muted-foreground">
                                    Previously ordered: {item.previouslyOrdered} | Current order: {item.quantity}
                                  </p>
                                  <p className="text-sm text-muted-foreground">
                                    Total ordered: {item.previouslyOrdered + item.quantity}
                                  </p>
                                </div>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant={getStatusVariant(order.status)}>{order.status.replace("-", " ")}</Badge>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {order.paymentStatus === "pending" && (
                          ...
                          >
                            ...
                            {updatingOrder === order.id ? "Updating..." : "Mark Paid"}
                          </Button>
                        )}
                        {order.paymentStatus === "paid" && order.status !== "delivered" && (
                          ...
                          >
                            ...
                            {updatingOrder === order.id ? "Updating..." : "Mark Complete"}
                          </Button>
                        )}
                      </div>
                    </TableCell>
